...
## ⚠️ bindInline doit cibler le formulaire VISIBLE
...
⚠️ **Les zones non sélectionnées doivent rester discrètes** (opacité ~9 %) : à pleine
intensité elles masquent le corps et le schéma devient illisible.
