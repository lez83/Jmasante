...
const ORDER_DEV  = ['globals','storage','seed','ui','sheets','nav','engine','share','fiche','dictate','features','seq','sync','pwa','init'];
...
const ORDER_PROD = ['globals','storage','seed','ui','sheets','nav','engine','share','fiche','dictate','features','seq','sync','pwa','init'];
