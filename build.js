...
const ORDER_DEV  = ['globals','uikit','storage','seed','ui','sheets','nav','engine','share','fiche','dlu','feuilles','menage','traitement','tendances','dossier','vocal','recueil','docs','plaies','dictate','features','seq','sync','pwa','init'];
...
const ORDER_PROD = ['globals','uikit','storage','seed','ui','sheets','nav','engine','share','fiche','dlu','feuilles','menage','traitement','tendances','dossier','vocal','recueil','docs','plaies','dictate','features','seq','sync','pwa','init'];
