...
ck('mobile et fixe du patient dans l\'annuaire', /Le patient — mobile/.test(sh2) && /Le patient — fixe/.test(sh2));
ck('le patient figure en TÊTE de l\'annuaire',
   sh2.indexOf('Le patient — mobile') < sh2.indexOf('medecinsDe(p).filter(m => m.nom||m.tel).map'));
