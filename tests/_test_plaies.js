...
function run(){
  ...
  w.eval(appjs + '\n;window.__P = { PLAIE_TYPES, PLAIE_REGIONS, plaieRegionsSVG, plaieNom, plaieJours, plaiePhotos, plaiesOuvertes, docPlaieOuverte, plaieTexteReleve, plaieToutesZones, plaieRegionDe, plaieSilhouette, sheetPlaies, getP, plaieFil, plaieDerniereNote };');
