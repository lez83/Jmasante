...
let _soinNotes = {}; _soinNotesRel = {}; // commentaires par soin pour le passage en cours
...
function _saveDraft(f, pid){
  ...
  _formDraft = { pid, soins, consts, taS, taD, note, soinNotes:{..._soinNotes}, soinNotesRel:{..._soinNotesRel}, constRel, dardOn };
}
function _restoreDraft(f, pid){
  ...
  if (!_formDraft || _formDraft.pid !== pid){
    ...
    if (v){
      _formDraft = { pid, soins:[...(v.soins||[])], consts:{...(v.consts||{})},
                     taS:"", taD:"", note:v.note||"",
                     soinNotes:{...(v.soinNotes||{})}, soinNotesRel:{...(v.soinNotesRel||{})}, constRel:!!v.constRel, dardOn:!!v.dar,
                     _editUid:v.uid };
  ...
  if (!_formDraft || _formDraft.pid !== pid){ _soinNotes = {}; _soinNotesRel = {}; return; }
  const d = _formDraft;
  ...
  const commitVisit = async (silent) => {
    ...
    if (editUid){
      ...
      if (ev){
        ...
        _soinNotes = {}; _soinNotesRel = {}; _formDraft = null;
