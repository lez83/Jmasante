...
function sheetPatient(p){
  ...
  openSheet(`
    ...
    <div class="field"><span class="lab">Personne à prévenir</span>
      <div style="display:grid;grid-template-columns:1.3fr 1fr;gap:7px">
        <input id="f-pap-nom" placeholder="Nom et lien (ex : Mme Martin, fille)" value="${esc((p.prevenir||{}).nom||'')}">
    ...
    ${!isNew ? `<div class="rowb" style="margin-top:12px">
      <button class="btn btn-sm" id="f-dlu" style="flex:1;background:#7a1616;border-color:#a01c1c;color:#fff">🚑 DLU urgence</button>
      <button class="btn btn-ghost btn-sm" id="f-feuilles" style="flex:1;border-color:var(--accent);color:var(--accent)">🖨️ Feuilles domicile</button>
      <button class="btn btn-ghost btn-sm" id="f-export" style="flex:1">📄 Exporter la fiche</button>
...
function sheetGraphConstantes(pid){
  ...
  const render = () => {
    ...
    openSheet(`
      ...
      <button class="btn btn-ghost" id="gcl" style="margin-top:8px">← Retour</button>`);
