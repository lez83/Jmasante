  ...
  $$("#cstpick [data-cst]").forEach(b => b.onclick = () => {
    ...
    if (S.constStyle === "tableau") aideUne("tuiles", { ic:"📊", titre:"Constantes en tableau de bord",
      sub:"Ouvre la carte d'un patient : chaque constante a sa tuile, avec sa <b>dernière valeur</b> et <b>quand</b> elle a été prise.<br><br>" +
          ...
          "La date passe en <b>ambre</b> au-delà de 24 h : la valeur est ancienne. Une constante jamais mesurée reste en place, estompée." });
  });
...
<p class="small" style="margin-bottom:8px"><b>🪪 Cartes patient</b> : <b>Pastille</b> (petit rond en haut à droite) ou <b>Bande latérale</b> (tout le bord gauche coloré, avec 📞 pour appeler et 📍 pour l'itinéraire directement sur la carte). Les couleurs sont les mêmes : <b>ambre</b> à voir · <b>vert</b> vu · <b>rouge</b> vigilance · <b>gris</b> absent ou sans passage. La <b>légende</b> s'affiche au-dessus de la liste ; « Ne plus afficher » la replie en <b>ⓘ Légende</b>, qui la rouvre d'un toucher.</p>
...
function sheetAppPanel(){
  menuSheet("⚙️ Application", `
    ...
    <p class="small muted" style="margin-bottom:10px">Bande latérale : le statut colore tout le bord gauche de la carte, avec 📞 et 📍 à portée de pouce.</p>
